...
public class Contains extends VCFAbstractFilter {
	...
	public Contains(String key, String val, String sampleName, String alleleName) {
		this(key, val, sampleName, alleleName, Contains.class);
	}

	protected Contains(String key, String val, String sampleName, String alleleName, Class<?> clazz) {
