...
public class NotEquals extends VCFAbstractFilter {
	...
	public NotEquals(String key, String val, String sampleName, String alleleName) {
		this(key, val, sampleName, alleleName, NotEquals.class);
	}

	protected NotEquals(String key, String val, String sampleName, String alleleName, Class<?> clazz) {
	...
	private static String generateDescription(String key, String val, String sampleName, String alleleName, Class<?> clazz) {
		String s = key + " not equals " + val + " (in ";
		if (sampleName == null || sampleName.equals("")) {
			s += "all samples";
		} else {
			s += "sample: "+sampleName;
