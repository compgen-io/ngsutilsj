...
public class NotInList extends VCFAbstractFilter {
	...
	public NotInList(String key, String[] vals, String sampleName, String alleleName) {
		this(key, vals, sampleName, alleleName, NotInList.class);
	}

	protected NotInList(String key, String[] vals, String sampleName, String alleleName, Class<?> clazz) {
	...
	private static String generateDescription(String key, String[] vals, String sampleName, String alleleName, Class<?> clazz) {
		String s = key + " not in " + StringUtils.join(", ", vals) + " (in ";
		if (sampleName == null || sampleName.equals("")) {
			s += "all samples";
		} else {
			s += "sample: "+sampleName;
	...
	private static String generateID(String key, String[] vals, String sampleName, String alleleName, Class<?> clazz) {
		String s = key + "_notin_" + StringUtils.join("_", vals);
		if (sampleName != null && !sampleName.equals("")) {
			s += "_"+sampleName;
		}
