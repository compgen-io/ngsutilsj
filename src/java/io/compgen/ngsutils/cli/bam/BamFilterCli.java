...
public class BamFilterCli extends AbstractCommand {
    ...
    @Option(desc = "Keep only read names from this include list", name = "includeist", helpValue = "fname")
    public void setWhitelist(String includeList) {
    ...
    public void exec() throws CommandArgumentException, IOException {
        ...
        if (junctionIncludeList != null) {
            parent = new JunctionWhitelist(parent, false, junctionIncludeList);
            if (verbose) {
                System.err.println("JuntionWhitelist: " + junctionIncludeList);
            }
        }
